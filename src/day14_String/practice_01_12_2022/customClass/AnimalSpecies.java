...
- action: assigns the name, population, and growth rate of the object given from the parameters.
    ...
    public String name;// we should privet  but her just EXAMPLE
    public int population;// getter and setter just for privet
    public int growthRate;


    public void setInfo(String name, int population, int growthRate) { //get, set
        this.name = name;
