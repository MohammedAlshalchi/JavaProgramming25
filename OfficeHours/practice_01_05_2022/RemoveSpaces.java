...
/*  (RemoveSpaces)
    ...
    public static void main(String[] args) {
        ...
        removeSpaces(input);// NO need to print statement because no return type we just need to call the method
    }
    ...
    public static void removeSpaces(String str){
        ...
        System.out.println(result.trim());// to remove the last space because ( each+ " " )
