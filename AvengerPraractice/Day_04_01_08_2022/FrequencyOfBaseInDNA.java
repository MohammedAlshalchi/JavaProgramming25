...
A:6 C:4 G:5 T:6
    ...
    private static String findFrequencyOfBaseInDNA(String dna) {// this method to return string
    ...
    private static int findFrequencyOfLetter(String dna, char ch) {// this method return frequency
        int counter=0;
